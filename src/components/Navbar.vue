<template>
  <div class="fixed-bottom d-flex justify-content-center">
    ...
    <!-- dashboard -->
    <svg v-if="user" :class="view == 'dashboard' ? 'active' : ''" @click="switchRoute('dashboard')"
    ...
    <!-- login -->
    <svg v-if="!user" :class="view == 'login' ? 'active' : ''" @click="switchRoute('login')"
      xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-left"
      viewBox="0 0 16 16">
